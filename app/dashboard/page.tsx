  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/dashboard/players" className="block p-6 bg-white border rounded-lg shadow hover:bg-slate-50 transition-colors">
        ...
        <Link href="/dashboard/admin/teams" className="block p-6 bg-white border rounded-lg shadow hover:bg-slate-50 transition-colors">
        ...
        <Link href="/dashboard/admin/users" className="block p-6 bg-white border rounded-lg shadow hover:bg-slate-50 transition-colors">
