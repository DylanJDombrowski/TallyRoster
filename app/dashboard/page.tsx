...
export default function DashboardHomePage() {
  return (
    <div className="p-8">
      ...
      <p className="mb-8">Welcome to the Miami Valley Xpress management platform.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/dashboard/players" className="block p-6 bg-white border rounded-lg shadow hover:bg-gray-50">
          ...
          <p className="text-sm text-gray-600">Add, edit, and view player rosters for all teams.</p>
        </Link>
        ...
        <Link href="/dashboard/admin/teams" className="block p-6 bg-white border rounded-lg shadow hover:bg-gray-50">
          <h2 className="text-lg font-semibold mb-2">Manage Teams</h2>
          <p className="text-sm text-gray-600">Create and edit teams for the organization.</p>
        </Link>
        ...
        <Link href="/dashboard/admin/users" className="block p-6 bg-white border rounded-lg shadow hover:bg-gray-50">
          ...
          <p className="text-sm text-gray-600">Invite new coaches and admins to the platform.</p>
        </Link>
