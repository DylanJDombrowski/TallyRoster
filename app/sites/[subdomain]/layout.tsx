...
// Correct the import name from DynamicThemeStyles to ThemeStyle
  ...
  return (
    <OrganizationProvider organization={organization}>
      <div className="flex flex-col min-h-screen">
        {/* Correct the component name and pass the expected props */}
        <ThemeStyle
          primaryColor={organization.primary_color || "#161659"}
          secondaryColor={organization.secondary_color || "#BD1515"}
          primaryFgColor={"#ffffff"} // Assuming white as default foreground
          ...
          <div className="container mx-auto py-4 px-4">
            <div className="flex items-center justify-center">
              ...
              <div className="text-center md:text-left">
                <h1 className="text-2xl md:text-5xl uppercase font-medium" style={{ color: "var(--color-primary)" }}>
                  {organization.name}
                </h1>
